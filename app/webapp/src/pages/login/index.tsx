      ...
      <div className="glass-card rounded-[2.5rem] p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="flex p-1 bg-muted/50 rounded-2xl gap-1">
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-sm font-bold transition-all ${loginMode === "password" ? "bg-card shadow-sm text-primary" : "text-muted-foreground hover:bg-muted"
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 py-2 rounded-xl text-sm font-bold transition-all ${loginMode === "otp" ? "bg-card shadow-sm text-primary" : "text-muted-foreground hover:bg-muted"
              }`}
          >
